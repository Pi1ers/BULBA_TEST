...
const backgroundsData = [
    { name: 'Стандарт', type: 'free', req: 0, price: 0, url: 'default' },
    { name: 'Огород', type: 'buy', req: 0, price: 0, url: 'https://raw.githubusercontent.com/Pi1ers/BULBA_TEST/refs/heads/main/IMG%20BACJGROUND/ogorod.jfif' },
    { name: 'Поле', type: 'achievement', req: 'rich_10000', price: 0, url: 'https://raw.githubusercontent.com/Pi1ers/BULBA_TEST/refs/heads/main/IMG%20BACJGROUND/поле.jfif' },
    { name: 'Завод', type: 'level_buy', req: 5, price: 5000, url: 'https://raw.githubusercontent.com/Pi1ers/BULBA_TEST/refs/heads/main/IMG%20BACJGROUND/завод.jfif' }
];

///////// МАССИВ ЦЕН ДЛЯ АВТОФАРМИЛКИ /////////
const autoFarmCosts = [1000, 5000, 10000, 25000, 75000, 120000, 250000, 500000, 1000000];
